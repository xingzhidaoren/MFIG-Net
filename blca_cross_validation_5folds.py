...
if __name__ == '__main__':
    ...
    for fold, (traind_ids, val_ids) in enumerate(kfold.split(dataset)):
        ...
        ckpoint_save_path = 'checkpoints/'+ build_fold_path('blca', classifier, frm_gama, fold+1)
        ...
        for mask_r in [0.3]:
            metric_save_path = 'results/' + build_fold_path('blca', classifier, frm_gama, fold+1) + '/maskr{0}'.format(mask_r)
